...
export default function Home() {
  ...
  useEffect(() => {
    const fetchOfferListings = async () => {
      try {
        const res = await fetch(
          "https://market-place-jj5i.onrender.com/api/listing/get?offer=true&limit=4",
        );
    ...
    const fetchRentListings = async () => {
      try {
        const res = await fetch(
          "https://market-place-jj5i.onrender.com/api/listing/get?type=rent&limit=4",
        );
        const data = await res.json();
    ...
    const fetchSaleListings = async () => {
      try {
        const res = await fetch(
          "https://market-place-jj5i.onrender.com/api/listing/get?type=sale&limit=4",
        );
        const data = await res.json();
    ...
    <div>
      ...
      <div className="mx-auto flex max-w-6xl flex-col gap-6 p-28 px-3">
        ...
        <div className="text-xs text-gray-400 sm:text-sm">
          WF Estate is the best place to find your next perfect place to live.
          <br />
